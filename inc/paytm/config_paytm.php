<?php
	...
	*/
	...
	define('INDUSTRY_TYPE_ID', 'xxxxxxx'); // Change this constant's value with Industrty type given by Paytm.
	define('CHANNEL_ID', 'xxxxxxx'); // Change this constant's value with website channel given by Paytm.
	define('CALLBACK_URL', 'http://localhost/trinity/pay_response.php'); // Change this constant's value with website channel given by Paytm.
