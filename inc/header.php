                            ...
                            <ul>
                                <?php
                                    if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
                                        ...
                                        echo <<<data
                                            <li>
                                                <button type="button" class="btn btn-outline-dark btn-sm shadow-none me-lg-3 me-2" data-bs-toggle="modal" data-bs-target="#loginModal">
                                                    Login
                                                </button>
                                            </li>
                                            <li>
                                                <button type="button" class="btn btn-outline-dark btn-sm shadow-none" data-bs-toggle="modal" data-bs-target="#registerModal">
                                                    Register
                                                </button>
                                            </li>
                                        data;
...
<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-dark px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
                <a href="rooms.php" class="btn btn-md custom-bg text-white btn-outline-dark rounded-0 shadow-none">Book Now <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
</nav>
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Your details must match with your ID (National ID, Passport, etc. ...) that will be required during check-in.
                    </span>
