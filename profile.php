                    ...
                    <form id="info-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input name="phonenum" type="phonenum" value="<?php echo $u_fetch['phonenum'] ?>" class="form-control shadow-none" required>
                            </div>
                    ...
                    <form id="pass-form">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="new_pass" type="text" class="form-control shadow-none" required>
                            </div>

                            <div class="col-md-6 mb-4">
                                <label class="form-label">Confirm Password</label>
                                <input name="confirm_pass" type="phonenum" class="form-control shadow-none" required>
                            </div>
                        </div>
                        <button type="submit" class="btn text-white custom-bg shadow-none">Save Changes</button>
                    </form>
