...
<body>
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold text-center p-font">CONTACT US</h2>
        <div class="h-line bg-dark"></div>
        <p class="text-center mt-3">
        Your feedback, questions, and suggestions are important to us. We're here to assist you in any way we can. Please feel free to reach out:
        </p>
    </div>
